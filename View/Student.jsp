                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6 header-right">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li style="width:-1px">
                                    <a href="Controller?param=Student">Student</a>
                                    <ul>
                                ...
                                <li style="width:-1px">
                                    <a href="Controller?param=FacultyHome">Faculty</a>
                                    <ul>
                                        <li><a href="Controller?param=Student">Community Contents [Self learning]</a></li>
                                        <li><a href="Controller?param=Login">Practice/Mock Exams</a></li>
                                    </ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <button type="submit">Explore <i class="fa fa-search" aria-hidden="true"></i></button>
                        </form>-->
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-lg-4 col-md-4 first-box-footer">
                            <a href=""><img src="../common/design/images2/logo.png"></a>
