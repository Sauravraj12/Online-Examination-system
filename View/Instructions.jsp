            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="connect">
                        ...
                        <form id="login_frm" name="login_frm" onsubmit="openFullscreen()" method="post" class="form-horizontal"  role="form" action="Controller?param=Test&user=${data[1]}&email=${data[0]}&cmbSubject=${data[2]}">
